...
class CompoundType(GeneratedsSuper):
    ...
    def factory(self, **kwargs_):
        ...
        if CompoundType.subclass:
            return CompoundType.subclass(*self, **kwargs_)
        return CompoundType(*self, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def validate_CompoundKind(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                ...
                result = False
    def hasContent_(self):
        return bool((self.name is not None or self.member))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CompoundType', fromsubclass_=False, pretty_print=True):
        ...
        for member_ in self.member:
            namespaceprefix_ = (
                f'{self.member_nsprefix_}:'
                if (UseCapturedNS_ and self.member_nsprefix_)
                else ''
            )
...
class MemberType(GeneratedsSuper):
    ...
    def factory(self, **kwargs_):
        ...
        if MemberType.subclass:
            return MemberType.subclass(*self, **kwargs_)
        return MemberType(*self, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
...
def get_required_ns_prefix_defs(rootNode):
    ...
    namespacedefs = ' '.join(
        [f'xmlns:{prefix}="{uri}"' for prefix, uri in nsmap.items()]
    )
